...
macro(set_dependencies_dir depds_dir)
    ...
    set(dependencies_DIR ${depds_dir} )
    message(STATUS "dependencies_DIR=${depds_dir}")
endmacro()

# find package
macro(find_dependency_package var_name)
    if(NOT EXISTS ${dependencies_DIR}/${PKM_SYSTEM_ARCH}/${var_name}/)
        message(FATAL_ERROR "${dependencies_DIR}/${PKM_SYSTEM_ARCH}/${var_name} does not exist" )
    endif()

    set(CMAKE_PREFIX_PATH ${dependencies_DIR}/${PKM_SYSTEM_ARCH}/${var_name}
    )
...
macro(find_dependency_thirdparty var_name)
    if(NOT EXISTS ${dependencies_DIR}/${PKM_SYSTEM_ARCH}/thirdparty/${var_name}/)
        message(FATAL_ERROR "${dependencies_DIR}/${PKM_SYSTEM_ARCH}/${var_name} does not exist" )
    endif()

    set(CMAKE_PREFIX_PATH 
    	${dependencies_DIR}/${PKM_SYSTEM_ARCH}/thirdparty/${var_name}/
    	${CMAKE_PREFIX_PATH}
